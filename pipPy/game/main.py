            ...
            for col in range(3):
                ...
                if color == red:
                    pygame.draw.line(screen, white, (x+10, y+10),
                                     (x+size_block-10, y-10+size_block), 3)
                    pygame.draw.line(screen, white, (x+size_block-10, y+10),
                                     (x+10, y+size_block-10), 3)
                elif color == green:
                    pygame.draw.circle(
                        screen, red, (x+size_block//2, y+size_block//2), size_block//2-3, 3)
    if (query - 1) % 2 == 0:
